  ...
  apps: [
    {
      ...
      script: 'npm',
      args: 'start',
      cwd: '/home/codecrafter/combined/website',
    ...
    },
    {
      ...
      script: 'node',
      args: 'server.cjs',
      cwd: '/home/codecrafter/combined/Schoolars-work-bench/artifacts/scholar-forge',
      instances: 1,
      exec_mode: 'fork',
    ...
    },
    {
      ...
      script: 'npm',
      args: 'start',
      cwd: '/home/codecrafter/combined/Schoolars-work-bench/artifacts/api-server',
    ...
    },
    {
      ...
      cwd: '/home/codecrafter/combined/website/backend/go-services',
      instances: 1,
      exec_mode: 'fork',
      env: { PORT: 9001 },
